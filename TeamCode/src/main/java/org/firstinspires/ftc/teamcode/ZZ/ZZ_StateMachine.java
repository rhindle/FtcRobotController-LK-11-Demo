...
/*
    ...
    Pass your opMode.telemetry as the argument so it has access to the telemetry methods.
        ZZ_StateMachine.addTelemetry([Telemetry telemetry]);
...
public class ZZ_StateMachine {

    /* Instance tracking */
    static ArrayList<ZZ_StateMachine> list = new ArrayList<>();
     ...
     */
    public ZZ_StateMachine(String name) {
        list.add(this);
        this.name = name;
    ...
    public static void reset() {
        list = new ArrayList<ZZ_StateMachine>();
        pausedAll = false;
    }
    ...
    private static String getCallingClass() {
        String myName = ZZ_StateMachine.class.getName();
...
//    }
     ...
     */
    private static void controlGroups(runModeChange mode, String[] names, ZZ_StateMachine caller) {
     ...
     */
    public ZZ_StateMachine setAutoRestart(boolean state) {
        autoRestart = state;
        return this;
    }
     ...
     * @return this, for method chaining.
     */
    public ZZ_StateMachine setAbortOnTimeout(boolean state) {
     ...
     * @return this, for method chaining.
     */
    public ZZ_StateMachine setTimeLimit (long timeLimit) {
        // sanitize input?

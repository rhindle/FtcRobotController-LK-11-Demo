...
public class ZZ_ServoSSR implements Servo {
    ...
    public ZZ_ServoSSR(Servo servo) {
        this.servo = servo;
    }
     ...
     */
    public ZZ_ServoSSR setOffset(double offset) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setSweepTime(int sweepTime) {
        this.sweepTime = (int)clamp(sweepTime, 0, 5000);
        this.sweepTimeDec = (int)clamp(sweepTime, 0, 5000);
        return this;
    }
    public ZZ_ServoSSR setSweepTime(long sweepTime) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setSweepTime(int sweepTimeTo1, int sweepTimeTo0) {
        this.sweepTime = (int)clamp(sweepTimeTo1, 0, 5000);
        this.sweepTimeDec = (int)clamp(sweepTimeTo0, 0, 5000);
        return this;
    }
    public ZZ_ServoSSR setSweepTime(long sweepTimeTo1, long sweepTimeTo0) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setSweepSpeed(double speed, double fullRangeAngle, double loadFactor) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setWakeTime(int wakeTime) {
        this.wakeTime = (int)clamp(wakeTime,0,1000);
        return this;
    }
    public ZZ_ServoSSR setWakeTime(long wakeTime) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setScale(double scale) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setFullPwmRange() {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setPwmRange(double low, double high) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR setDirectionSSR(Direction direction) {
     ...
     * @return this for method chaining
     */
    public ZZ_ServoSSR resetTime(int delay) {
        timer = System.currentTimeMillis() + (long)clamp(delay,0,5000);
        return this;
    }
    public ZZ_ServoSSR resetTime() {
